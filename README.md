...
-d '{
   ...
   "first_message": "Hi, I'm calling from the Gate's Foundation. Do you have a minute to answer some questions about public health?",
   "number": "18316014980"
   }'
```

```bash
curl -X POST https://9f4d-73-234-103-2.ngrok-free.app/outbound-call \
-H "Content-Type: application/json" \
-d '{
